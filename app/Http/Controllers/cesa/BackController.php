                ...
                $result = db::transaction(function() use($response){
                    ...
                    foreach ($data as $group) {
                        ...
                        $sppb = SPPB::create([
                            ...
                            'no_bl_awb'            => $header['noBlAwb'] ?? $header['noMasterBlAwb'] ?? null,
            ...
            try {
                ...
                $result = db::transaction(function() use($response){
                    ...
                    $sppb = SPPB::create([
                        ...
                        'no_bl_awb'            => $header['nomorBlAwb'] ?? $header['nomorMasterBlAwb'] ?? null,
                ...
                return response()->json([
                    ...
                    'message' => $cfsSuccess
                        ...
                        : 'Data berhasil disimpan, tetapi pengiriman ke CFS Center gagal :' . ($cfsResponse['message'] ?? null),
                    'cfs_success' => $cfsSuccess ?? null,
                    'cfs_status' => $cfsStatus ?? null,
                    'cfs_response' => $cfsResponse ?? null,
                ]);
    ...
    public function coariCont()
    {
        ...
        foreach ($containersFCL as $container) {
            ...
            $header = [
                ...
                "refNumber" => '1MUT' . date('ymdHis') . Str::upper(Str::random(2)),
