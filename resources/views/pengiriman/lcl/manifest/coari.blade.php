    ...
    <div class="card">
        <div class="card-header">
            <div class="button-container">
                <div class="col-auto">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addManual">Upload Coari KMS</button>
                <button type="button" class="btn btn-primary" id="testCoari">Upload Coari</button>
                </div>
            </div>
        </div>
        <div class="card-body">
        ...
        $(document).on('click', '#submit', function(){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '{{ route('pengiriman.lcl.kirimManualManifest')}}',
                        type: 'POST',
                        data : {
                            _token: "{{ csrf_token() }}",
                            id: id,
...
<script>
    $(document).ready(function(){
        $('#dataCoariCont').DataTable({
            ...
            serverSide: true, 
            scrollX: true,
            ajax: '{{ route('pengiriman.lcl.manifestData')}}',
            columns: [
