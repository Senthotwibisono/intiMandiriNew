    ...
    <div class="card">
        <form action="{{ route('dokumen.bc23.update.detail')}}" method="post" id="createForm">
                ...
                <div class="row mt-5">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="">Car</label>
                            <input type="text" class="form-control" name="id" value="{{$dok->car}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="tgl_dok_inout" value="{{ \Carbon\Carbon::createFromFormat('Ymd', $dok->tgl_dok_inout)->format('Y-m-d') }}">            
                        </div>
                        <div class="form-group">
            ...
            <div class="card-footer">
                <a href="{{ route('dokumen.pabean.index')}}" class="btn btn-outline-danger">Back</a>
