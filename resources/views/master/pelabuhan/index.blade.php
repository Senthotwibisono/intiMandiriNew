            ...
            <table class="tabelCustom table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-warning formEdit" data-id="{{ $pelabuhan->id }}" id="formEdit"><i class="fa fa-pen"></i></button>
                            <button class="btn btn-danger" data-id="{{ $pelabuhan->id }}" id="deleteUser-{{ $pelabuhan->id }}"><i class="fa fa-trash"></i></button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
...
<div class="modal fade" id="addManual" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Add Data Pelabuhan</h5>
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close"> <i data-feather="x"></i></button>
            </div>
            <form action="{{ route('master.pelabuhan.post')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="row mb-5">
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <select name="jenis" class="customSelect form-select select2" style="width: 100%;">
                                    <option value="" disabeled selected>Plih Satu!</option>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <select name="negara_id" class="customSelect form-select select2" style="width: 100%;">
                                    <option value="" disabeled selected> Pilih Satu!</option>
...
<div class="modal fade" id="editCust" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Edit Data Pelabuhan</h5>
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close"> <i data-feather="x"></i></button>
            </div>
            <form action="{{ route('master.pelabuhan.update')}}" method="POST" id="updateForm" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="row mb-5">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="id_edit" class="form-control" name="id" required>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="">Kode</label>
                                <input type="text" class="form-control" name="kode" id="kode_edit" required>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="">Jenis</label>
                                <select name="jenis" id="jenis_edit" class="editSelect form-select select2" style="width: 100%;">
                                    <option value="" disabeled selected>Plih Satu!</option>
                                    <option value="L">L</option>
                                    <option value="F">F</option>
                                </select>
...
<script>
    ...
    button.addEventListener('click', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`/master/pelabuhan-delete${userId}`, {
                    method: 'DELETE',
                    headers: {
   ...
   $(document).on('click', '.formEdit', function() {
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        $("#editCust #kode_edit").val(response.data.kode);
        $("#editCust #jenis_edit").val(response.data.jenis).trigger('change');
