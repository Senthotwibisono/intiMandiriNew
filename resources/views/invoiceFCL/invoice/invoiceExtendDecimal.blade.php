...
.container {
    ...
    .grid {
        ...
        border-radius: 2px;
        box-shadow: 0px 1px 4px rgba(0, 2, 2, 2.1);
    }
        ...
        <div class="card-header">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-3"><strong>Perpanjangan Dari</strong></div>
                        <div class="col-8">: {{$header->eta}}</div>
                    </div>
                    <div class="row">
                        <div class="col-3"><strong>Sampai Dengan</strong></div>
                    ...
                    <div class="row">
                        <div class="col-3"><strong>No. Invoice Expired</strong></div>
                        <div class="col-8">: {{$header->form->oldInvoice->invoice_no ?? '-'}}</div>
                    </div>
                </div>
            </div>
        </div>
