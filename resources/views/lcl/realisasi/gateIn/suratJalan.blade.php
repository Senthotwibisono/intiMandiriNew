    ...
    <div class="container">
        <div class="card">
            <div class="row">
                ...
                <div class="col-4">
                    <span style="font-size: 20px;">{{$cont->job->nojoborder ?? ''}}</span>
                </div>
            </div>
            <br>
            ...
            <div class="row">
                <div class="col-8">
                    <div class="row">
                        ...
                        <div class="col-7">
                            ...
                            <span>: {{$cont->job->Kapal->name}}</span><br>
                            <span>: {{$cont->job->eta ?? '-'}}</span><br>
                            <span>: {{$cont->nopol_mty ?? '-'}}</span><br>
                            <span>: LKB</span><br>
                            <span>: {{$cont->nobl ?? '-'}}</span><br>
                            <span>: -</span><br>
                        </div>
                    </div>
                </div>
                ...
                <br>
                <br>
                <span style="text-decoration: underline; font-size: 14px;"><strong>{{$cont->DepoMty->name ?? '-'}}</strong></span><br>
                <span style="text-decoration: underline; font-size: 14px;"><strong>{{$cont->DepoMty->alamat ?? '-'}}</strong></span>
                </div>
            </div>
            <br>
            <div class="col-12">
                <div class="table table-responsive">
                    <table class="tabel-stripped mx-auto">
                        ...
                        <tbody>
                            <tr>
                                <td class="text-center" style="font-size: 14px;">{{$cont->nocontainer}}</td>
                                <td class="text-center" style="font-size: 14px;"> 1 x {{$cont->size}} Feet</td>
