...
<script>
    $(document).on('click', '.releaseButton', function() {
        ...
        Swal.fire({
            title: "Konfirmasi",
            text: "Apakah Anda yakin ingin melepaskan container ini?",
            icon: "warning",
            ...
            if (result.isConfirmed) {
                ...
                // Kirim AJAX request
                $.ajax({
                    url: '/bc/fcl/releaseFCLCont', // Ganti dengan URL endpoint
                    type: 'POST',
                    ...
                    success: function(response) {
                        if (response.success) {
                            Swal.fire({
                                title: "Berhasil!",
                                text: "Container berhasil dilepas.",
                                icon: "success"
                            }).then(() => {
...
<script>
    $(document).ready(function(){
        $('#tableContainer').dataTable({
            ...
            serverSide: true,
            scrollX: true,
            ajax: '/bc/fcl/holdContainerDataTable',
            columns: [
                {data:'release', name:'release'},
                {data:'photo', name:'photo'},
                {data:'alasan_hold', name:'alasan_hold'},
