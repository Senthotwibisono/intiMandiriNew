...
<section>
    <div class="card">
        ...
        <form action="{{route('bc.behandle.update')}}" id="updateForm" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row mt-1">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label for="">Status Behandle</label>
                            <select name="status_behandle" id="status_behandle_edit" class="js-example-basic-single" style="width: 100%;">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" name="date_check_behandle" id="date_check_behandle_edit" class="form-control">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="">Desc </label>
                                    <textarea name="desc_check_behandle" class="form-control" id="desc_check_behandle_edit" cols="3"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
   ...
   $(document).on('click', '.editButton', function() {
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        $("#status_behandle_edit").val(response.data.status_behandle).trigger('change');
      },
      error: function(data) {
...
$(document).on('click', '.approveButton', function() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: 'POST',
                url: '/bc/lcl/delivery/approve-' + id,
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                cache: false,
