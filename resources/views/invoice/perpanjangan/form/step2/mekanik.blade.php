                    ...
                    <tbody>
                        @foreach($selectedTarifMekanik as $index => $tarif)
                            <tr>
                                ...
                                <td>
                                    <input type="number" class="form-control jumlah-volume-mekanik" name="jumlah_volume_mekanik[{{$index}}]" value="{{$tarif->jumlah ?? form->cbm}}" step="0.01" id="jumlah_volume_{{$index}}_mekanik" data-index="{{$index}}">
                                </td>
                                <td>
