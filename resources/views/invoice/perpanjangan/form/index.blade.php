                ...
                <tbody>
                    @foreach($forms as $form)
                        <tr>
                            ...
                            <td>
                                <a href="/invoice/form/perpanjangan/formStep1/{{$form->id}}" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
...
<script>
    document.getElementById('createForm').addEventListener('click', function() {
        fetch('/invoice/form/perpanjangan/create', {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            if (data.id) {
                ...
                window.location.href = `/invoice/form/perpanjangan/formStep1/${data.id}`;
            }
        });
    });
</script>
