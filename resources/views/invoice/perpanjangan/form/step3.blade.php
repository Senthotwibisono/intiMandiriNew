...
<form action="/invoice/form/perpanjangan/submitStep3" method="post" enctype="multipart/form-data">
    @csrf
        <div class="row">
            <div class="col-6">
                <section id="preinvoice-content">
                    @include('invoice.perpanjangan.form.preinvoice')
                </section>
            </div>
            @if($form->mekanik_y_n == 'Y')
            <div class="col-6">
                <section id="preinvoice-content">
                    @include('invoice.perpanjangan.form.preinvoiceMekanik')
                </section>
            </div>
            @endif
        </div>
