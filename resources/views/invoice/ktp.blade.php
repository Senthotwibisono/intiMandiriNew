    ...
    <div class="container">
       <div class="card">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    <td class="text-center">
                                        <img src="{{ asset('storage/ktp/' . $header->ktp) }}" alt="Photo" class="img-fluid" style="width: 400px; height: 400px; object-fit: cover;">
                                    </td>
                                    <!-- <td>
                                        <form action="{{ route('lcl.gateIn.delete.detail')}}" method="POST">
                                            @csrf
                                            <input type="hidden" name="id" value="{{$header->ktp}}">
            ...
            <div class="card-footer">
                <div class="text-center">
                    {{$header->order_no}} -- {{$header->order_at}} -- {{$header->manifest->nohbl}} <br> {{$header->no_hp}}
                </div>
            </div>
       </div>
    </div>
