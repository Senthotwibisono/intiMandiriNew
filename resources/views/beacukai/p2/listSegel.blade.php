...
<div class="modal fade text-left" id="lockModal" tabindex="-1" role="dialog"aria-labelledby="myModalLabel17" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg"role="document">
        <div class="modal-content">
            ...
            <form action="/bc-p2/list-segelMerah/unlockSubmit" id="createForm" method="post" enctype="multipart/form-data">
                @csrf
...
<script>
    $(document).ready(function(){
        $('#tableListManifest').DataTable({
            processing: true,
            serverSide: true,
            ajax: '/bc-p2/list-segelMerah/data',
            columns:[
                {data:'id', name:'id', className:'text-center', orderable: false,
                    render: function(data, type, row) {
                        ...
                        return `<a href="javascript:void(0)" onclick="openWindow('/bc-p2/detil-log/${data}')" class="btn btn-sm btn-info"><i class="fa fa-eye"></i></a>`; // Mengembalikan kosong jika tidak dalam kondisi 'HOLDP2'
                    }
                },
                {data:'status_bc', name:'status_bc', className:'text-center'},
                {data:'alasan_segel', name:'alasan_segel', className:'text-center'},
                {data:'alasan_lepas_segel', name:'alasan_lepas_segel', className:'text-center'},
            ...
            //     // Untuk setiap kolom, tambahkan input filter
